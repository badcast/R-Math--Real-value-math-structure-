...
namespace rmath {
   namespace func{
      ...
      // const value
      //    export const rmath::real_t minusOne { 0, -1, 1 };
      //    export const rmath::real_t zero { 0, 0, 1 };
      //    export const rmath::real_t one { 0, 1, 1 };
      //    export const rmath::real_t two { 0, 2, 1 };
      //    export const rmath::real_t NaN { 0, 0, 0 };
      //    export const rmath::real_t positiveInfinity { 0, 1, 0 };
      //    export const rmath::real_t negativeInfinity { 0, -1, 0 };
